...
contract Escrow is Ownable {
    ...
    bool _called_enableRefunds = false;
    address _user_1;

    /// #if_updated (!_called_enableRefunds) ==> (old(_deposits[_user_1]) <= _deposits[_user_1]);
...
contract RefundEscrow is ConditionalEscrow {
    ...
    constructor(address payable beneficiary_, address inst) {
