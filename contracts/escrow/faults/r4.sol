...
// _sum is used here, as automating the correction to unchecked_sum(_deposits) is non-trivial.
/// #invariant _called_beneficiaryWithdraw ==> (address(this).balance == 0);
/// #invariant (!_called_beneficiaryWithdraw) ==> (address(this).balance == _sum);
contract RefundEscrow is ConditionalEscrow {
    bool _called_beneficiaryWithdraw = false;
